...
export default function SocialMediaHandlingPage() {
  ...
  return (
    ...
    <Navbar />
      ...
      <section id="platforms" className="w-full py-16 relative z-10 bg-transparent">
  {/* Centered Content Container - max-w-6xl keeps it in the middle */}
  <div className="relative max-w-6xl mx-auto bg-white/40 backdrop-blur-2xl rounded-[3rem] p-8 md:p-12 border border-white/50 shadow-2xl">
    <motion.div
    ...
    >
      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur-md border border-purple-200/50 mb-6">
        <Globe className="text-purple-600" size={16} />
        <span className="text-purple-600 font-black text-[10px] uppercase tracking-[0.2em]">Local Market Reach</span>
      </div>
      <h2 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tight mb-4">
        Connect with Amravati's <br />
        <span className="bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 bg-clip-text text-transparent">Digital Audience</span>
      </h2>
    ...
    {/* Scaled Down Platform Grid */}
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full mx-auto">
      {[
        {
          name: "Instagram",
          icon: <FaInstagram className="text-white" size={22} />,
          stats: "25,000+ Users",
        ...
        {
          name: "Facebook",
          icon: <FaFacebookF className="text-white" size={22} />,
          stats: "45,000+ Active",
        ...
        },
        {
          ...
          stats: "18,000+ Daily",
          location: "Regional MH",
          desc: "Video Content & Local Business Shorts",
          color: "bg-gradient-to-br from-red-600 to-red-700",
        },
        {
          name: "LinkedIn",
          icon: <FaLinkedinIn className="text-white" size={22} />,
          stats: "12,000+ Pros",
          location: "MH Network",
        ...
        {
          name: "X", 
          icon: <RiTwitterXFill className="text-white" size={22} />,
          stats: "8,000+ Local",
          location: "Amravati",
        ...
        <motion.div
          ...
          className="group"
        >
          <div className="bg-white/80 rounded-[2rem] p-6 border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-300 h-full flex flex-col">
            <div className="flex items-center gap-4 mb-4">
              <div className={`${platform.color} w-12 h-12 rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform flex-shrink-0`}>
                {platform.icon}
              </div>
              <div className="flex-1">
                <h3 className="font-black text-lg text-gray-900 leading-tight">{platform.name}</h3>
                <div className="flex items-center gap-1.5 mt-0.5">
                  <TrendingUp className="text-green-500" size={14} />
                  <span className="font-bold text-gray-900 text-xs">{platform.stats}</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-auto pt-4 border-t border-gray-50 flex items-center gap-2">
              ...
              <span className="text-gray-500 text-[11px] font-semibold uppercase tracking-wider">{platform.location}</span>
            </div>
          </div>
        </motion.div>
      ))}
