...
// logo floating button "use client";
...
//   return (
//     <>
//       {/* --- FLOATING FULL-SCREEN LOGO BUTTON WITH GREEN DOT --- */}
//       <div className="fixed bottom-6 right-6 z-50">
//         <button
//           onClick={() => setIsChatOpen(true)}
//           className="group relative flex h-16 w-16 items-center justify-center transition-all duration-300 active:scale-90"
//         >
//           {/* Animated Background Aura */}
//           <div className="absolute inset-0 animate-spin-slow rounded-full bg-gradient-to-tr from-[#8b5cf6] via-[#ec4899] to-[#f43f5e] opacity-40 blur-xl transition-all duration-700 group-hover:opacity-70 group-hover:blur-2xl"></div>

//           {/* Full-Screen Logo Container */}
//           <div className="relative h-14 w-14 rounded-full overflow-hidden border-2 border-white shadow-2xl transition-transform duration-300 group-hover:scale-110">
//              <Image 
//                 src="/boalogo.svg" 
//                 alt="BOA Logo" 
//                 fill
//                 className="object-cover transition-transform group-hover:rotate-12"
//                 priority
//              />
//              {/* Shine Sweep Effect */}
//              <div className="absolute inset-0 translate-x-[-100%] bg-gradient-to-r from-transparent via-white/40 to-transparent transition-transform duration-1000 group-hover:translate-x-[100%]"></div>
//           </div>

//           {/* Green Status Dot */}
//           <span className="absolute right-1 top-1 flex h-4 w-4">
//             <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-green-400 opacity-75"></span>
//             <span className="relative inline-flex h-4 w-4 rounded-full bg-green-500 border-2 border-white shadow-sm"></span>
//           </span>
//         </button>
//       </div>
